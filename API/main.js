...
app.get('/api/produtos/:sku', async (req, res) => {
    ...
    try {
        ...
        const result = await pool.query('SELECT "PREÇO MARGEM MINIMA RAIA" as lprice,  "IC NOVO SITE/LOJA RAIA PONDERADO" as ic, "RBV L1M" as rbv,"PANVEL" AS "panvel", "DT INICIO OFERTA RAIA" AS "dtInicio", "DT FIM OFERTA RAIA" AS "dtFim" FROM "produtos" WHERE "PRODUTO" = $1', [sku]);
