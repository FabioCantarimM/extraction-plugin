...
app.get('/api/produtos/:sku', async (req, res) => {
    ...
    try {
        ...
        const result = await pool.query('SELECT "PRODUTO", "NOTABILIDADE", "MENOR PREÇO RAIA", "NOME COMPETIDOR RAIA", "MG MÍN RAIA", "POSICIONAMENTO RAIA", "BANNER", "TRATATIVAS RAIA", "LB NOVO RAIA", "RBV L1M", "RBV L1M POND","OUTLIER IC","IC ATUAL RAIA/CONCORRENTE POND", "IC NOVO SITE/LOJA RAIA PONDERADO" FROM drogadata WHERE sku_monitorado = $1', [sku]);
